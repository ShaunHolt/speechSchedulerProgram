...
public class TableCellRender extends DefaultTableCellRenderer{
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,boolean selected, boolean focused, int row, int column)
    {
        ...
        if(value!=null)
        {
            if(Integer.parseInt(value.toString())== SchedulerCalPage.realDay && SchedulerCalPage.currentMonth == SchedulerCalPage.realMonth && SchedulerCalPage.currentYear == SchedulerCalPage.realYear)
            {
            ...
            else if((new File("specialEventsLog.dat")).exists() || true)
            {
                try
                {
                    ...
                    while((str=br.readLine())!=null)
                    {
                        ...
                        if(Integer.parseInt(value.toString())== d && SchedulerCalPage.currentMonth == m && SchedulerCalPage.currentYear == y)
                        {
                            System.out.println(""+Integer.parseInt(value.toString())+" "+d);
                            System.out.println(""+SchedulerCalPage.currentMonth+" "+m);
                            System.out.println(""+SchedulerCalPage.currentYear+" "+y);
